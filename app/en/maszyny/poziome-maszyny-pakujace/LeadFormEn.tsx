...
export default function LeadFormEn({ defaultModel = '' }: { defaultModel?: string }) {
  ...
  function validate(): boolean {
    ...
    if (!form.email.trim()) e.email = 'E-mail address is required';
    else if (!/\S+@\S+\.\S+/.test(form.email)) e.email = 'Invalid e-mail address';
  ...
  async function submit(ev: React.FormEvent) {
    ...
    try {
      await emailjs.send(EJS_SERVICE, EJS_TEMPLATE, {
        ...
        message:    `Model: ${form.model || 'not specified'}\nPhone: ${form.phone || 'not provided'}${form.message ? `\n\n${form.message}` : ''}`,
        produkt:    'ENQUIRY [EN] — Horizontal Flow Pack Machines (GSP)',
      }, EJS_KEY);
      setState('success');
        ...
        <Box sx={{
          ...
          <Box>
            ...
            <Typography component="h2" sx={{
              ...
              Send us an enquiry about the GSP flow pack
            </Typography>
            <Typography sx={{ fontSize: '0.95rem', color: TEXT_DIM, lineHeight: 1.8, mb: 4 }}>
              We will help you select the right model for your product, throughput and packaging requirements.
              We typically respond within 1 business day.
            </Typography>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              {[
                'Model selection for your product and throughput',
                'Pricing and lead time',
                'Machine demonstration available',
          ...
          <Box component="form" onSubmit={submit} noValidate sx={{
            ...
            {state === 'error' && (
              <Alert severity="error">
                Something went wrong. Please try again or call: +48 123 454 397.
              </Alert>
            )}
            ...
            <TextField
              select fullWidth label="Model you are interested in"
            ...
            <TextField
              fullWidth label="Additional information" multiline rows={3}
            ...
            <FormControlLabel
              ...
              label={
                <Typography sx={{ fontSize: '0.78rem', color: TEXT_DIM, lineHeight: 1.5 }}>
                  I consent to the processing of my personal data by PPHU MadejPak Sp.&nbsp;z&nbsp;o.o.
                  for the purpose of handling this enquiry.{' '}
