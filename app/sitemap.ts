...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/maszyny/poziome-maszyny-pakujace`,    lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
  ...
  const enStaticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/en/maszyny/poziome-maszyny-pakujace`,             lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
