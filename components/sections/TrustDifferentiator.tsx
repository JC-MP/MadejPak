...
const CONTENT = {
  pl: {
    ...
    highlights: [
      { label: 'Draże Skawa', sub: 'legendarne wyroby cukiernicze', slug: 'skawa' },
      ...
      { label: 'Draże Unitop', sub: 'wyroby cukiernicze', slug: '' },
  ...
  en: {
    ...
    highlights: [
      { label: 'Skawa dragées', sub: 'confectionery', slug: 'skawa' },
      ...
      { label: 'Unitop dragées', sub: 'confectionery', slug: '' },
